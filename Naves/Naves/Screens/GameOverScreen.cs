...
namespace Naves
{
    ...
    class GameOverScreen : GameScreen
    {
        ...
        /// Constructor.
        /// </summary>
        public GameOverScreen(Opciones Opciones, Partida partida)
        {
        ...
        public override void Activate(bool instancePreserved)
        {
            if (!instancePreserved)
            {
                ...
                backgroundTexture = content.Load<Texture2D>("Screens\\Game_Over");
                capaTexture = content.Load<Texture2D>("Screens\\CapaGameOver");
                                                       ...
                                                       bool coveredByOtherScreen)
        {
            ...
            if (gameTime.TotalGameTime - previoTimeCapa > pausaCapa)
            {
                if (!bMusicaGameOver)
                {
                    ...
                    Sonidos.PlayMusic(eMusica.GameOver, false, opciones);

                    bMusicaGameOver = true;
                }
            ...
            if (hastaY == capaY)
                if (bNoPulsado)
                {
                    ...
                    if (bTeclaRaton)
                    {
                        ...
                        //LoadingScreen.Load(ScreenManager, false, ControllingPlayer, new MainMenuScreen(opciones, partida));
