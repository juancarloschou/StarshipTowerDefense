...
namespace Naves
{
    ...
    /// <summary>
    /// Enemigo aereo, el que camina por el tablero, ignorando las torres
    /// </summary>
    abstract class EnemigoAereo : EnemigoBase
    {
        ///////////////////////////////////////
        // PROPIEDADES
        ///////////////////////////////////////
        ...
        ////////////////// CONSTRUCTOR //////////////////
        public EnemigoAereo(Vector2 posicion, Tablero tablero, eTipoEnemigo tipoEnemigo, int nivel = 0, bool bAnimacion = true)
            : base(posicion, eTipoMovimiento.Aereo, tipoEnemigo, nivel, bAnimacion)
        {
        ...
        {
            camino = null;
            Pathfinder pathFinder = new Pathfinder(eSearchTipo.Aereo);
