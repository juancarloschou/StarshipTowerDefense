...
namespace Naves
{
    class TorreAntiAire : TorreBase
    {
        ...
        ////////////////// CONSTRUCTOR //////////////////
        public TorreAntiAire(Point coord, int id, int nivel = 0)
            : base(coord, eTipoTorre.AntiAire, id, nivel)
        {
        ...
        public static void LoadContent(ContentManager Content)
        {
            ...
            //torre
            spriteTorre.imagen = Content.Load<Texture2D>("Sprites\\torre_antiair_01");
        ...
        protected override void UpdateDisparos(GameTime gameTime, Tablero tablero, Torres torres, Enemigos enemigos, Nave nave, Opciones opciones)
        {
            ...
            UpdateApuntar(tablero, enemigos, true); //solo apunta a aereos
                ...
                if (!enemigos.enemigos[apuntaEnemigo].bEliminar)
                {
                    if (gameTime.TotalGameTime - previoDisparo >= TimeSpan.FromSeconds(1 / Ratio))
                    {
                        ...
                        torres.disparos.AddDisparo(gameTime, posicionTorre, CasillasTorre(tipoTorre, tablero), id, Daño, 
                                                   velocidadDisparo, radioExplosion, posicionEnemigo, apuntaEnemigo, eTipoTorreDisparo.Misil);
