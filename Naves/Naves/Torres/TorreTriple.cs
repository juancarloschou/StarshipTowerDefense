...
namespace Naves
{
    class TorreTriple : TorreBase
    {
        ...
        ////////////////// CONSTRUCTOR //////////////////
        public TorreTriple(Point coord, int id, int nivel = 0)
            : base(coord, eTipoTorre.Triple, id, nivel)
        {
        ...
        public static void LoadContent(ContentManager Content)
        {
            ...
            //torre
            spriteTorre.imagen = Content.Load<Texture2D>("Sprites\\torre_triple_01");
                ...
                if (!enemigos.enemigos[apuntaEnemigo].bEliminar)
                {
                    if (gameTime.TotalGameTime - previoDisparo >= TimeSpan.FromSeconds(1 / Ratio))
                    {
                        ...
                        torres.disparos.AddDisparo(gameTime, posicionTorre, CasillasTorre(tipoTorre, tablero), id, Daño,
                                                   velocidadDisparo, radioExplosion, posicionEnemigo, apuntaEnemigo, eTipoTorreDisparo.Triple);
